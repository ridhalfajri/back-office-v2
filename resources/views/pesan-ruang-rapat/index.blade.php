            ...
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">
                        ...
                        onclick="window.location.href = '{{ route('pesan-ruang-rapat.create') }}';">
                        Pesan Ruang Rapat</button>
                    </h4>
                </div>
                <div class="card-body">
                    ...
                    <div class="row clearfix">
                        <div class="col-12 col-lg-6 col-md-6">
                            <div class="form-group @error('ruangRapat')has-error @enderror">
                                <label class="form-label">Ruang Rapat</label>
                                <select id="ruangRapat" name="ruangRapat" class="form-control">
                                    <option value="">--Pilih--</option>
                                    @foreach ($dataRuangRapat as $data)
                ...
                <div class="card-body">
                    <h5 class="box-title" style="text-align: center;"><b>List Pesanan Ruang Rapat</b></h5>
                    ...
                    <thead>
                        <tr>
                            ...
                            <th class="font-weight-bold text-dark">Nama Rapat</th>
                            <th class="font-weight-bold text-dark">Ruang Rapat</th>
                            <th class="font-weight-bold text-dark">Tanggal</th>
                            <th class="font-weight-bold text-dark">Waktu Mulai</th>
                            <th class="font-weight-bold text-dark">Waktu Selesai</th>
    ...
    <script type="text/javascript">
        ...
        $(function() {
            ...
            table = $('#tbl-data').DataTable({
                ...
                autoWidth: false,
                ajax: {
                    url: '{{ route('pesan-ruang-rapat.datatable') }}',
                    type: 'POST',
                    headers: {
                ...
                columns: [{
                    ...
                    {
                        data: 'waktu_mulai',
                        name: 'prr.waktu_mulai',
                        class: 'text-center'
                    },
                    {
                        data: 'waktu_selesai',
                        name: 'prr.waktu_selesai',
                        class: 'text-center'
                    },
                    {
                        data: 'aksi',
                    ...
                    if (isConfirm) {
                        delete_data(that.data('id')).then(function(hasil) {
                            if (hasil.status.error == true) {
                                toastr['error']('Data Pesanan Ruang Rapat gagal di hapus!');
                            } else {
                                table.ajax.reload();
    ...
    function delete_data(id) {
            return new Promise(function(resolve, reject) {
                $.ajax({
                    ...
                    reject('Gagal menghapus data Pesanan Ruang Rapat!');
                })
            })
        }
</script>

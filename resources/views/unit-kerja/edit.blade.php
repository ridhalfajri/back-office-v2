        ...
        <div class="card">
            <div class="card-body">
                <div class="card-content">
                    ...
                    <form class="needs-validation" id="form-uker" method="post" action="{{ route('unit-kerja.update',$unit->id) }}" accept-charset="utf-8" novalidate>
                        @csrf
                        @method('PATCH')
                            ...
                            <div class="col-12 col-lg-6 col-md-6">
                                ...
                                <div class="form-group @error('is_active')has-error @enderror">
                                    ...
                                    <select id="is_active" name="is_active" class="form-control">
                                        <option value="">--Pilih--</option>
                                        @if ($unit->is_active == 'Y' || old('is_active') == 'Y')
                                            <option value="Y" selected>Aktif</option>
                                        @else
                                            <option value="Y">Aktif</option>
                                        @endif
    
                                        @if ($unit->is_active == 'N' || old('is_active') == 'N')

            ...
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">
                        ...
                        onclick="window.location.href = '{{ route('aturan-thr-gajiplus.create') }}';">
                        Tambah</button>
                    </h4>
                </div>
                <div class="card-body">
                ...
                <div class="card-body">
                    <h5 class="box-title" style="text-align: center;"><b>List Master Aturan THR dan Gaji-13</b></h5>
                    ...
                    <thead>
                        <tr>
                            ...
                            <th class="font-weight-bold text-dark">Persentase Tukin</th>
                            <th class="font-weight-bold text-dark">Persentase Lainnya</th>
...
<!-- Data Tables -->
    ...
    <script type="text/javascript">
        ...
        $(function() {
            ...
            table = $('#tbl-data').DataTable({
                ...
                autoWidth: false,
                ajax: {
                    url: '{{ route('aturan-thr-gajiplus.datatable') }}',
                    type: 'POST',
                    headers: {
                ...
                columns: [{
                    ...
                    {
                        data: 'persentase_tukin',
                        name: 'persentase_tukin',
                        class: 'text-center',
                    },
                    {
                        data: 'persentase_lainnya',
                        name: 'persentase_lainnya',
                        class: 'text-center',
                    },
                    {
                        data: 'status',
                    ...
                    if (isConfirm) {
                        delete_data(that.data('id')).then(function(hasil) {
                            if (hasil.status.error == true) {
                                toastr['error']('Data Aturan THR dan Gaji-13 gagal di hapus!');
                            } else {
                                table.ajax.reload();
    ...
    function delete_data(id) {
            return new Promise(function(resolve, reject) {
                $.ajax({
                    url: "{{ url('master/aturan-thr-gajiplus') }}/" + id,
                    method: 'POST',
                    headers: {
                        'X-CSRF-TOKEN': '{{ csrf_token() }}'
                    },
                    ...
                    reject('Gagal menghapus data Aturan THR dan Gaji-13!');
                })
            })
        }
</script>

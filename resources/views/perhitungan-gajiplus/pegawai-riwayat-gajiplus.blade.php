            ...
            <div class="col-lg-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        @endif
                        <label class="form-label"><i>Perhitungan Gaji-13</i></label>
                    ...
                    <div class="card-body">
                        <h5 class="box-title" style="text-align: center;"><b>List Riwayat Gaji-13 Pegawai</b></h5>
    ...
    <script type="text/javascript">
        ...
        $(function() {
            table = $('#tbl-data').DataTable({
                ...
                autoWidth: false,
                ajax: {
                    url: '{{ route('pegawai-riwayat-gajiplus.datatable') }}',
                    type: 'POST',
                    headers: {
            ...
            $('#exportExcel').on('click', function(e) {
                ...
                if (null === unitKerjaId || '' === unitKerjaId) {
                    window.location.href = '{{ url('kalkulasi/export-to-excel/gajiplus') }}/' +
                        tahun;
                } else {
                    window.location.href = '{{ url('kalkulasi/export-to-excel/gajiplus') }}/' +
                        tahun + '/' + unitKerjaId;
            ...
            $('#kalkulasi').on('click', () => {
                Swal.fire({
                    ...
                    text: "Kalkulasi Gaji-13 Pegawai " + $('#periode').val(),
                    icon: "warning",
                    ...
                    if (result.isConfirmed) {
                        $.ajax({
                            url: '{{ route('pegawai-riwayat-gajiplus.kalkulasi-gajiplus') }}',
                            type: "POST",
                            headers: {
                                'X-CSRF-TOKEN': '{{ csrf_token() }}'
                            },

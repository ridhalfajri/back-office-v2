        ...
        <div class="row clearfix">
            <div class="col-lg-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <h5 class="box-title" style="text-align: center;"><b>List Riwayat Gaji-13</b></h5>
                        ...
                        <table id="tbl-data" class="table table-hover js-basic-example dataTable table_custom spacing5">
                            <thead>
                                <tr>
                                    ...
                                    <th class="font-weight-bold text-dark">Total Gaji-13</th>
    ...
    <script type="text/javascript">
        ...
        $(function() {
            table = $('#tbl-data').DataTable({
                ...
                autoWidth: false,
                ajax: {
                    url: '{{ route('riwayat-gajiplus.datatable') }}',
                    type: 'POST',
                    headers: {
                ...
                columns: [{
                    ...
                    },
                    {
                        ...
                        name: 'pegawai_riwayat_gajiplus.nominal_gaji_pokok',
                        class: 'text-center',
                        render: $.fn.dataTable.render.number('.', ',', 2, 'Rp')
                    },
                    {
                        data: 'tunjangan_beras',
                        name: 'pegawai_riwayat_gajiplus.tunjangan_beras',
                        class: 'text-center',
                        render: $.fn.dataTable.render.number('.', ',', 2, 'Rp')
                    },
                    {
                        data: 'tunjangan_pasangan',
                        name: 'pegawai_riwayat_gajiplus.tunjangan_pasangan',
                        class: 'text-center',
                        render: $.fn.dataTable.render.number('.', ',', 2, 'Rp')
                    },
                    {
                        data: 'tunjangan_anak',
                        name: 'pegawai_riwayat_gajiplus.tunjangan_anak',
                        class: 'text-center',
                        render: $.fn.dataTable.render.number('.', ',', 2, 'Rp')
                    },
                    {
                        data: 'tunjangan_jabatan',
                        name: 'pegawai_riwayat_gajiplus.tunjangan_jabatan',
                        class: 'text-center',
                        render: $.fn.dataTable.render.number('.', ',', 2, 'Rp')
                    },
                    {
                        data: 'tunjangan_kinerja',
                        name: 'pegawai_riwayat_gajiplus.tunjangan_kinerja',
                        class: 'text-center',
                        render: $.fn.dataTable.render.number('.', ',', 2, 'Rp')
                    },
                    {
                        data: 'total_gajiplus',
                        name: 'pegawai_riwayat_gajiplus.total_gajiplus',
                        class: 'text-center',
                        render: $.fn.dataTable.render.number('.', ',', 2, 'Rp')
                    },
                    {
                        data: 'tahun',
                        name: 'pegawai_riwayat_gajiplus.tahun',
                        class: 'text-center'
                    },
                ],
                columnDefs: [{

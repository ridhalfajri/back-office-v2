<div class="item-action dropdown ml-2">
    ...
    <div class="dropdown-menu dropdown-menu-right">
        <a href="javascript:void(0)" class="dropdown-item btn-tmt-gaji" data-toggle="modal" data-target="#modal-tmt-gaji"
            id="btn-domisili" onclick="edit_tmt_gaji({{ $id }})"><i class="dropdown-icon fa fa-edit"></i>
            Ubah</a>

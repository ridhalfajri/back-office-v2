...
@push('breadcrumb')
        <div class="btn-group btn-breadcrumb">
            ...
            <a href="{{ route('pegawai.show', $pegawai->id) }}" class="btn btn-light"><i class="fa fa-list"></i> Data Pegawai</a>
        ...
        <div class="card">
            <div class="card-body">
                <div class="card-content">
                    <form class="needs-validation" id="pegawaiFormEdit" method="post"  action="{{ route('pegawai.update',$pegawai->id) }}"  accept-charset="utf-8" novalidate>
                        @csrf
                        @method('PUT')
                        ...
                        <div class="row clearfix">
                          ...
                          <div class="form-group col-sm-6 col-md-6">
                              ...
                              <div class="input-group">
                                  <input data-provide="datepicker" id="tanggal_lahir" name="tanggal_lahir"
                                      ...
                                      value="{{ \Carbon\Carbon::parse($pegawai->tanggal_lahir)->format('d-m-Y') }}" data-date-format="dd/mm/yyyy"
                          ...
                          <div class="form-group col-sm-3 col-md-3">
                              ...
                              <select class="form-control" id="status_dinas" name="status_dinas">
                                <option value="0" @if ($pegawai->status_dinas == '0') selected @endif>Tidak Aktif</option>
                                <option value="1" @if ($pegawai->status_dinas == '1') selected @endif>Aktif</option>
                              </select>
                          ...
                          <div class="form-group col-sm-4 col-md-4">
                              ...
                              <div class="input-group">
                                  <input data-provide="datepicker" id="tanggal_berhenti" name="tanggal_berhenti"
                                      ...
                                      value="{{ !empty($pegawai->tanggal_berhenti) ? \Carbon\Carbon::parse($pegawai->tanggal_berhenti)->format('d-m-Y') : '' }}" data-date-format="dd/mm/yyyy"
                                      class="form-control datepicker">
                              </div>
                          ...
                          <div class="form-group col-sm-4 col-md-4">
                              ...
                              <div class="input-group">
                                  <input data-provide="datepicker" id="tanggal_wafat" name="tanggal_wafat"
                                      ...
                                      value="{{ !empty($pegawai->tanggal_wafat) ? \Carbon\Carbon::parse($pegawai->tanggal_wafat)->format('d-m-Y') : '' }}" data-date-format="dd/mm/yyyy"
                                      class="form-control datepicker">
                              </div>
                          ...
                          <div class="form-group col-md-6 col-sm-6">
                              ...
                              <div class="input-group">
                                  ...
                                  @if (!empty($pegawai->media_foto_pegawai))
                                    <a href="{{ $pegawai->media_foto_pegawai->getUrl() }}">File Sekarang :
                                      {{ $pegawai->media_foto_pegawai->name }}</a>
                                  @endif
                              </div>
                          </div>
                          ...
                          <div class="form-group col-md-6 col-sm-6">
                              ...
                              <div class="input-group">
                                  ...
                                  @if (!empty($pegawai->media_kartu_pegawai))
                                    <a href="{{ $pegawai->media_kartu_pegawai->getUrl() }}">File Sekarang :
                                      {{ $pegawai->media_kartu_pegawai->name }}</a>
                                  @endif
                              </div>
                          </div>
                        </div>

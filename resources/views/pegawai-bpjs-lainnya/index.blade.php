            ...
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">
                        ...
                        onclick="window.location.href = '{{ route('pegawai-bpjs-lainnya.create') }}';">
                        Tambah</button>
                    </h4>
                </div>
                <div class="card-body">
                ...
                <div class="card-body">
                    <h5 class="box-title" style="text-align: center;"><b>List Tambahan BPJS Pegawai</b></h5>
                    ...
                    <thead>
                        <tr>
                            ...
                            <th class="font-weight-bold text-dark">Total Tambahan<br>Orang Tua</th>
                            <th class="font-weight-bold text-dark">Total Tambahan<br>Mertua</th>
                            <th class="font-weight-bold text-dark">Total Tambahan<br>Anak</th>
...
<!-- Data Tables -->
    ...
    <script type="text/javascript">
        ...
        $(function() {
            ...
            table = $('#tbl-data').DataTable({
                ...
                autoWidth: false,
                ajax: {
                    url: '{{ route('pegawai-bpjs-lainnya.datatable') }}',
                    type: 'POST',
                    headers: {
                ...
                columns: [{
                    ...
                    },
                    {
                        ...
                        name: 'pbl.total_orang_tua',
                        class: 'text-center'
                    },
                    {
                        data: 'total_mertua',
                        name: 'pbl.total_mertua',
                        class: 'text-center'
                    },
                    {
                        data: 'total_kelebihan_anak',
                        name: 'pbl.total_kelebihan_anak',
                        class: 'text-center'
                    },
                    {
                        data: 'status',
                    ...
                    if (isConfirm) {
                        delete_data(that.data('id')).then(function(hasil) {
                            if (hasil.status.error == true) {
                                toastr['error']('Data Tambahan BPJS Pegawai gagal di hapus!');
                            } else {
                                table.ajax.reload();
    ...
    function delete_data(id) {
            return new Promise(function(resolve, reject) {
                $.ajax({
                    url: "{{ url('pegawai-bpjs-lainnya') }}/" + id,
                    method: 'POST',
                    headers: {
                        'X-CSRF-TOKEN': '{{ csrf_token() }}'
                    },
                    ...
                    reject('Gagal menghapus data Tambahan BPJS Pegawai!');
                })
            })
        }
</script>

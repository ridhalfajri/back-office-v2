                        ...
                        <div class="row clearfix">
                            <div class="col-12 col-lg-12 col-md-12">
                                <div class="form-group ">
                                    ...
                                    <input class="form-control"  id="golongan_id" name = "golongan_id" value = "{{ old('golongan_id') ?? $uangMakan->golongan_id }}" maxlength = "{0}" placeholder="Golongan Id" autocomplete="off"></input>                                            
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row clearfix">
                            <div class="col-12 col-lg-12 col-md-12">
                                <div class="form-group ">
                                    ...
                                    <input class="form-control"  id="nominal" name = "nominal" value = "{{ old('nominal') ?? $uangMakan->nominal }}" maxlength = "{0}" placeholder="Nominal" autocomplete="off"></input>                                            
                                </div>
                            </div>
                        </div>

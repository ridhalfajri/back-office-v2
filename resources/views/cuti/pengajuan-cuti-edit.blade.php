...
@section('content')
    <div class="col-md-8 col-lg-8">
        <div class="card">
            ...
            <form id="form-pengajuan" action="{{ route('cuti.update-cuti', $cuti->id) }}" enctype="multipart/form-data"
                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="form-group col-lg-8 col-md-6 col-sm-12">
                            ...
                            <input class="form-control input-daterange-datepicker" type="text" name="tanggal_cuti"
                                id="tanggal_cuti" value="{{ $cuti->tanggal_cuti }}">
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" id="no_telepon_cuti" name="no_telepon_cuti" class="form-control"
                            placeholder="No Telp" value="{{ $cuti->no_telepon_cuti }}">
                        <small class="text-danger" id="error_no_telepon_cuti"></small>

                    </div>
                    <div class="form-group">
                        <label class="form-label">Alasan Lengkap Cuti</label>
                        <textarea class="form-control" id="alasan" name="alasan" placeholder="Alasan Cuti">{{ $cuti->alasan }}</textarea>
                        <small class="text-danger" id="error_alasan"></small>
                    </div>
                    <div class="form-group">
                        <label class="form-label">Alamat / Lokasi Selama Menjalankan Cuti</label>
                        <textarea class="form-control" id="alamat_cuti" name="alamat_cuti" placeholder="Alamat Cuti">{{ $cuti->alamat_cuti }}</textarea>

        ...
        <div class="card">
            <div class="card-body">
                <div class="student-info">
                    ...
                    <form class="needs-validation" id="preTakTercatatForm" method="post"  action="{{ route('pre-tak-tercatat.update',$preTakTercatat->id) }}" enctype="multipart/form-data" accept-charset="utf-8" novalidate>
                        @csrf
                        @method('PUT')
                        ...
                        <div class="row clearfix">
                            ...
                            <div class="col-sm-4">
                                <div class="form-group @error('jenis') has-error @enderror">
                                    <select class="form-control btn" id="jenis" name="jenis" required>
                                        ...
                                        <option value="1" {{ old('jenis') == 1 || $preTakTercatat->jenis == 1 ? 'selected' : '' }}> Jam Masuk</option>
                                        <option value="2" {{ old('jenis') == 2 || $preTakTercatat->jenis == 2 ? 'selected' : '' }}> Jam Pulang</option>
                                    </select>
                            ...
                            <div class="col-sm-4">
                                <div class="form-group @error('tanggal_pengajuan') has-error @enderror">
                                    <input class="form-control" type="date" id="tanggal_pengajuan" name = "tanggal_pengajuan" value="{{ old('tanggal_pengajuan') ?? $preTakTercatat->tanggal_pengajuan }}" autocomplete="off" required/>
                        ...
                        <div class="row clearfix">
                            ...
                            <div class="col-sm-4">
                                <div class="form-group @error('jam_perubahan') has-error @enderror">
                                    <input class="form-control" type="time" id="jam_perubahan" name = "jam_perubahan" value="{{ old('jam_perubahan') ?? $preTakTercatat->jam_perubahan }}" autocomplete="off" required/>
                                    @error('jam_perubahan')
                                        <small class="text-danger">{{ $message }}</small>
                                    @enderror
                                </div>

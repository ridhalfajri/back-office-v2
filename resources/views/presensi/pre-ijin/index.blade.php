...
@push('breadcrumb')
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item"><a href="#">Riwayat Ijin Kehadiran</a></li>
...
@section('content')
    ...
    <div class="card">
        ...
        <div class="card-body">
            ...
            <h5><strong>Riwayat Ijin Kehadiranku<strong></h5>
            <br>
...
<script type="text/javascript">
    ...
    $(function() {
        ...
        table = $('#tbl-data').DataTable({
            ...
            buttons: [
                    {extend: 'excelHtml5',
                    title: 'Data Ijin Kehadiran Pegawai : ' + pegawaiDetail,

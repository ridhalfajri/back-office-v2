        ...
        <div class="card">
            <div class="card-body">
                <div class="bg-white">
                    <div class="btn-group btn-breadcrumb">
                         <h3>Form Pengajuan Dinas Luar</h3>
                    </div>
                </div>
            </div>
            ...
            <div class="card-body">
                <div class="student-info">
                    ...
                    <form class="needs-validation" id="preForm" method="post"  action="{{ route('pre-dinas-luar.store') }}" enctype="multipart/form-data"  accept-charset="utf-8" novalidate>
                        @csrf
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-10">
                                <div class="form-group @error('tanggal_dinas') has-error @enderror">
                                    <input class="form-control input-daterange-datepicker" type="text" name="tanggal_dinas" id="tanggal_dinas" required>
                                    @error('tanggal_dinas')
                                        <small class="text-danger">{{ $message }}</small>
                                    @enderror
                                </div>

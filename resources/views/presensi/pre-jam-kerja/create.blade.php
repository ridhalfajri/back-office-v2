                                        ...
                                        <div class="row clearfix">
                                            <div class="col-6 col-lg-6 col-md-6">
                                                <div class="form-group @error('mulai_jam_istirahat') has-error @enderror">
                                                    ...
                                                    <input class="form-control" type = "time" id="mulai_jam_istirahat" name = "mulai_jam_istirahat" value="{{ old('mulai_jam_istirahat') }}" placeholder="Mulai Jam Istirahat" autocomplete="off"/>
                                            ...
                                            <div class="col-6 col-lg-6 col-md-6">
                                                <div class="form-group @error('akhir_jam_istirahat') has-error @enderror">
                                                    ...
                                                    <input class="form-control" type = "time" id="akhir_jam_istirahat" name = "akhir_jam_istirahat" value="{{ old('akhir_jam_istirahat') }}" placeholder="Akhir Jam Istirahat" autocomplete="off"/>
                                        ...
                                        <div class="row clearfix">
                                            <div class="col-lg-6 col-md-6 col-sm-6">
                                                <div class="form-group @error('mulai_jam_istirahat_khusus') has-error @enderror">
                                                    <label>Jam Mulai<span class="text-danger"><sup>*</sup></span></label>
                                                    <input class="form-control" type = "time" id="mulai_jam_istirahat_khusus" name = "mulai_jam_istirahat_khusus" value="{{ old('mulai_jam_istirahat_khusus') }}" placeholder="Mulai Jam Istirahat Khusus" autocomplete="off"/>
                                            ...
                                            <div class="col-lg-6 col-md-6 col-sm-6">
                                                <div class="form-group @error('akhir_jam_istirahat_khusus') has-error @enderror">
                                                    <label>Jam Berakhir<span class="text-danger"><sup>*</sup></span></label>
                                                    <input class="form-control" type = "time" id="akhir_jam_istirahat_khusus" name = "akhir_jam_istirahat_khusus" value="{{ old('akhir_jam_istirahat_khusus') }}" placeholder="Akhir Jam Istirahat Khusus" autocomplete="off"/>

...
@push('breadcrumb')
    <div class="breadcrumb">
        <div class="btn-group btn-breadcrumb">
            ...
            <a href="#" class="btn btn-success"><i class="fa fa-pencil"></i> Input Hari Besar Baru</a>
        ...
        <div class="card  col-4">
            <div class="card-body">
                <div class="card-content">
                    <form class="needs-validation" id="hariLiburForm" method="post"  action="{{ route('hari-besar.store') }}"  accept-charset="utf-8" novalidate>
                        @csrf
                        ...
                        <div class="row clearfix">
                            <div class="col-12 col-lg-12 col-md-12">
                                <div class="form-group @error('tanggal') has-error @enderror">
                                    ...
                                    <input class="form-control" type="date" id="tanggal" name = "tanggal" value="{{ old('tanggal') }}" placeholder="Tanggal" autocomplete="off"/>
                                    @error('tanggal')

            ...
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">
                        ...
                        onclick="window.location.href = '{{ route('tunjangan-beras.create') }}';">
                        Tambah</button>
                    </h4>
                </div>
                <div class="card-body">
                ...
                <div class="card-body">
                    <h5 class="box-title" style="text-align: center;"><b>List Master Tunjangan Beras</b></h5>
                    ...
                    <thead>
                        <tr>
                            ...
                            <th class="font-weight-bold text-dark">Berat (kg)</th>
...
<!-- Data Tables -->
    ...
    <script type="text/javascript">
        ...
        $(function() {
            ...
            table = $('#tbl-data').DataTable({
                ...
                autoWidth: false,
                ajax: {
                    url: '{{ route('tunjangan-beras.datatable') }}',
                    type: 'POST',
                    headers: {
                    ...
                    if (isConfirm) {
                        delete_data(that.data('id')).then(function(hasil) {
                            if (hasil.status.error == true) {
                                toastr['error']('Data Tunjangan Beras gagal di hapus!');
                            } else {
                                table.ajax.reload();
    ...
    function delete_data(id) {
            return new Promise(function(resolve, reject) {
                $.ajax({
                    url: "{{ url('master/tunjangan-beras') }}/" + id,
                    method: 'POST',
                    headers: {
                        'X-CSRF-TOKEN': '{{ csrf_token() }}'
                    },
                    ...
                    reject('Gagal menghapus data Tunjangan Beras!');
                })
            })
        }
</script>

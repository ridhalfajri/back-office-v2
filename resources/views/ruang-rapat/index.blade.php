            ...
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">
                        ...
                        onclick="window.location.href = '{{ route('ruang-rapat.create') }}';">
                        Tambah</button>
                    </h4>
                </div>
                <div class="card-body">
                ...
                <div class="card-body">
                    <h5 class="box-title" style="text-align: center;"><b>List Master Ruang Rapat</b></h5>
                    ...
                    <thead>
                        <tr>
                            ...
                            <th class="font-weight-bold text-dark">Nama Ruang Rapat</th>
    ...
    <script type="text/javascript">
        ...
        $(function() {
            ...
            table = $('#tbl-data').DataTable({
                ...
                autoWidth: false,
                ajax: {
                    url: '{{ route('ruang-rapat.datatable') }}',
                    type: 'POST',
                    headers: {
                    ...
                    if (isConfirm) {
                        delete_data(that.data('id')).then(function(hasil) {
                            if (hasil.status.error == true) {
                                toastr['error']('Data Ruang Rapat gagal di hapus!');
                            } else {
                                table.ajax.reload();
    ...
    function delete_data(id) {
            return new Promise(function(resolve, reject) {
                $.ajax({
                    ...
                    reject('Gagal menghapus data Ruang Rapat!');
                })
            })
        }
</script>

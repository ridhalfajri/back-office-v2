...
class PegawaiRiwayatThrController extends Controller
{
    ...
    */
    ...
    {        
        ...
        $data = [];
        if('' != $tahun){ 
            $data = PegawaiRiwayatThr::select('p.nama_depan', 'p.nama_belakang', 'p.nip', 
            ...
            'pegawai_riwayat_thr.tahun', 'pegawai_riwayat_thr.total_thr', 'uk.nama as unit_kerja', 'uk.singkatan as singkatan_unit_kerja')

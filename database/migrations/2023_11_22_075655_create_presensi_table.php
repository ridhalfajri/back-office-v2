    ...
    */
    public function up()
    {
        Schema::create('presensi', function(Blueprint $table) {
             ...
             $table->enum('status_kehadiran',['HADIR','HADIR LEMBUR','ALPHA','CUTI','DINAS LUAR','TUGAS BELAJAR','LIBUR'])->nullable(false);
             ...
             $table->enum('is_online',['Y','N'])->nullable(false)->default('N');
             $table->timestamps();
        });
    }
